...
###  \*\* Plot of all duplicated of both acid and base titrations per SSA
...
plot_all <- ggplot(ALL_no_AL, aes(x = pH, y = net_app_m2, color=O_C)) +
  geom_point(shape=16, size=5) +
  #scale_color_viridis()+
  labs(#title = "Combined Acid-Base Titration",
       x = "pH",
...
XPS_OC_may24 <- read_excel("/Users/soliverchefusi/Library/CloudStorage/OneDrive-Personal/Desktop/Fusi/Sorption/AK_to_AO_Isotherm/Isotherm/XPS_OC.xlsx")
...
plot_all_dpH <- ggplot(df_9, aes(x = pH, y = dpH_dmol, group = SSN, color = O_C)) +
  ...
  theme(
    ...
    panel.grid.major = element_blank(),
    panel.grid.minor = element_blank(),
    legend.position = c(0.1, 0.8),  # Position the legend inside the plot
    legend.direction = "vertical",  # Rotate legend horizontally
    legend.text = element_text(size = 20),  # Adjust legend text size
    legend.title = element_text(size = 20, hjust = 0.5)  # Adjust legend title size
  ) +
  scale_color_gradient(low = "purple", high = "yellow")
plot_all_dpH 
